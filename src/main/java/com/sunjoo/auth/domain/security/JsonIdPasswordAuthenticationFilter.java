...
public class JsonIdPasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        Map<String, String> idPasswordMap = objectMapper.readValue(messageBody, Map.class);

        String id = idPasswordMap.get(ID_KEY);
        String password = idPasswordMap.get(PASSWORD_KEY);
